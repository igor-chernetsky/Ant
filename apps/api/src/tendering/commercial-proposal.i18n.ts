...
export interface CommercialProposalCopy {
  ...
  noAdjustment: string;
  clause4: string;
  contractDocumentsMutual: string;
  annex1Boq: string;
  ...
  clause8: string;
  governingLawMutualRespect: string;
...
const EN: CommercialProposalCopy = {
  ...
  noAdjustment:
    'No adjustment shall be allowed for changes in cost of materials, labour, equipment or services during the Contract period unless agreed in writing as an Additional agreement.',
  clause4: 'Clause 4 — Contract Documents',
  contractDocumentsMutual:
    'The documents forming the Contract are to be taken as mutually explanatory of one another. If an ambiguity or discrepancy is found in the documents, the Employer shall issue any necessary instructions to the Contractor.',
  ...
  defectWarrantyRemedial:
    "The Employer may at any time prior to the expiry of the period stated in the Contract, notify the Contractor of any defects or outstanding work. The Contractor shall remedy at no cost to the Employer any defects due to the Contractor's design, Materials, Plant or workmanship not being in accordance with the Contract.",
  ...
  clause8: 'Clause 8 — Governing Law and Jurisdiction',
  governingLawMutualRespect:
    "Both Parties agree to act on the principle of mutual respect, support, and taking into account each other's interests, as well as to settle disputes and disagreements in a pre-trial manner during negotiations, formalizing their results in writing.",
  governingLawAndJurisdiction:
    'This Contract shall be governed by and construed and interpreted according to the laws of the Kingdom of Thailand. In the event of any dispute arising from this Contract, such dispute shall be initially discussed by the Parties. Unless settled amicably, any dispute or difference which arises between the Contractor and the Employer out of or in connection with the Contract, including any valuation or other decision of the Employer, shall be referred by either Party to the Thai Arbitration Institute of the Alternative Dispute Resolution Office, Office of the Judiciary (the “TAI”). Place of Arbitration: Bangkok, Thailand.',
  footerNote:
...
const RU: CommercialProposalCopy = {
  ...
  noAdjustment:
    'Корректировка стоимости материалов, труда, оборудования или услуг в течение срока Договора не допускается, если иное не согласовано письменно как дополнительное соглашение.',
  clause4: 'Пункт 4 — Договорные документы',
  contractDocumentsMutual:
    'Документы, составляющие Договор, толкуются как взаимно поясняющие друг друга. При обнаружении неясности или противоречия в документах Заказчик выдаёт Подрядчику необходимые указания.',
  ...
  defectWarrantyRemedial:
    'Заказчик вправе в любое время до истечения срока, указанного в Договоре, уведомить Подрядчика о любых дефектах или незавершённых работах. Подрядчик обязан за свой счёт устранить любые дефекты, вызванные тем, что проектные решения Подрядчика, Материалы, Оборудование или качество работ не соответствуют Договору.',
  ...
  clause8: 'Пункт 8 — Применимое право и юрисдикция',
  governingLawMutualRespect:
    'Стороны обязуются действовать на принципах взаимного уважения, поддержки и учёта интересов друг друга, а также урегулировать споры и разногласия в досудебном порядке путём переговоров с оформлением их результатов в письменной форме.',
  governingLawAndJurisdiction:
    'Настоящий Договор регулируется и толкуется в соответствии с законодательством Королевства Таиланд. В случае возникновения спора из настоящего Договора Стороны сначала обсуждают его между собой. Если спор не урегулирован мирным путём, любой спор или разногласие между Подрядчиком и Заказчиком, вытекающие из Договора или связанные с ним, включая любую оценку или иное решение Заказчика, передаётся любой из Сторон в Thai Arbitration Institute of the Alternative Dispute Resolution Office, Office of the Judiciary («TAI»). Место арбитража: Бангкок, Таиланд.',
  footerNote:
...
const TH: CommercialProposalCopy = {
  ...
  noAdjustment:
    'ไม่อนุญาตให้ปรับราคาเนื่องจากต้นทุนวัสดุ แรงงาน อุปกรณ์ หรือบริการระหว่างอายุสัญญา เว้นแต่ตกลงเป็นลายลักษณ์อักษรในฐานะข้อตกลงเพิ่มเติม',
  clause4: 'ข้อ 4 — เอกสารสัญญา',
  contractDocumentsMutual:
    'เอกสารที่ประกอบเป็นสัญญาให้ถือว่าอธิบายซึ่งกันและกัน หากพบความคลุมเครือหรือข้อขัดแย้งในเอกสาร ผู้ว่าจ้างจะออกคำสั่งที่จำเป็นให้แก่ผู้รับจ้าง',
  ...
  defectWarrantyRemedial:
    'ผู้ว่าจ้างอาจแจ้งผู้รับจ้างเกี่ยวกับข้อบกพร่องหรืองานค้างใด ๆ ได้ตลอดเวลาก่อนครบกำหนดระยะเวลาที่ระบุในสัญญา ผู้รับจ้างต้องแก้ไขข้อบกพร่องที่เกิดจากการออกแบบ วัสดุ เครื่องจักร หรือฝีมือการทำงานของผู้รับจ้างที่ไม่เป็นไปตามสัญญา โดยไม่มีค่าใช้จ่ายแก่ผู้ว่าจ้าง',
  ...
  clause8: 'ข้อ 8 — กฎหมายที่ใช้บังคับและเขตอำนาจ',
  governingLawMutualRespect:
    'คู่สัญญาทั้งสองฝ่ายตกลงปฏิบัติตามหลักการเคารพซึ่งกันและกัน ให้การสนับสนุน และคำนึงถึงผลประโยชน์ของกันและกัน รวมทั้งระงับข้อพิพาทและความขัดแย้งโดยการเจรจาในชั้นก่อนฟ้อง โดยจัดทำผลลัพธ์เป็นลายลักษณ์อักษร',
  governingLawAndJurisdiction:
    'สัญญานี้ให้อยู่ภายใต้และตีความตามกฎหมายแห่งราชอาณาจักรไทย หากเกิดข้อพิพาทจากสัญญานี้ คู่สัญญาต้องหารือกันก่อน หากไม่สามารถระงับโดยสมัครใจ ข้อพิพาทหรือความแตกต่างใด ๆ ระหว่างผู้รับจ้างและผู้ว่าจ้างที่เกิดจากหรือเกี่ยวข้องกับสัญญา รวมถึงการประเมินมูลค่าหรือคำตัดสินอื่นใดของผู้ว่าจ้าง ให้คู่สัญญาฝ่ายใดฝ่ายหนึ่งส่งเรื่องไปยัง Thai Arbitration Institute of the Alternative Dispute Resolution Office, Office of the Judiciary (“TAI”) สถานที่อนุญาโตตุลาการ: กรุงเทพมหานคร ประเทศไทย',
  footerNote:
