export const enExtended = {
  ...
  progressSection: {
    ...
    attachPaymentSlip: "Attach payment slip",
    paymentSlipAttached: "Payment slip attached",
    downloadPaymentSlip: "Download payment slip",
    advancePaymentTitle: "Advance payment",
    advancePaymentAmount: "Contract advance",
    attachAdvancePaymentSlip: "Attach advance payment slip",
    advancePaymentSlipAttached: "Advance payment slip attached",
    paymentSlipHint: "Upload a copy of the bank transfer so both parties keep a record.",
