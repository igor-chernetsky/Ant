export const enExtended = {
  ...
  explainer: {
    ...
    clients: {
      ...
      quickLead: "Understand how to publish, compare, and sign without digging through the whole product.",
      heroKicker: "For clients",
      heroTitle: "Understand the project workflow in minutes",
      heroLead: "BuilTHAI helps you publish a project, collect contractor interest, compare proposals, and move to contract signing with less back-and-forth.",
      heroPrimaryCta: "Post a project",
      heroSecondaryCta: "Open help",
      mockupEyebrow: "Project workflow",
      mockupHeadline: "One place for scope, bids, and next actions",
      mockupDetail: "Keep project details, clarifications, proposals, and signatures in one flow instead of scattered chats and files.",
      mockupMetricTitle: "Clear next step",
      mockupMetricBody: "Publish, compare, sign",
      mockupPill1: "Project brief",
      mockupPill2: "Bid compare",
      mockupPill3: "Clarifications",
      mockupPill4: "Contract steps",
      stepsTitle: "How it works",
      stepsLead: "A quick path from idea to signed contractor.",
      steps: {
        step1Title: "Describe the job",
        step1Body: "Publish scope, location, files, and budget expectations so contractors can quickly understand the work.",
        step2Title: "Answer the important questions",
        step2Body: "Clarification questions are grouped and prioritized, so you can respond once and improve the brief for everyone.",
        step3Title: "Compare proposals clearly",
        step3Body: "Review applications, pricing, notes, and commercial proposals in one place instead of juggling messages.",
        step4Title: "Move into contract flow",
        step4Body: "Select a contractor, confirm terms, and keep signatures and follow-up project documents structured.",
      },
      benefitsTitle: "What you get",
      benefitsLead: "Built for faster decisions and less ambiguity.",
      benefits: {
        item1Title: "Less scope confusion",
        item1Body: "Shared clarifications and structured project fields help contractors quote against the same understanding.",
        item2Title: "Cleaner bid comparison",
        item2Body: "You can compare contenders without copying figures between spreadsheets and chat threads.",
        item3Title: "Better documentation",
        item3Body: "Project files, contract terms, and later milestones stay attached to the same project record.",
        item4Title: "A guided next step",
        item4Body: "The page always points to the next action, so you spend less time figuring out what to do next.",
      },
      faqTitle: "Common questions",
      faqLead: "The main concerns we expect from first-time clients.",
      faq: {
        item1Question: "Do I need a perfect brief before publishing?",
        item1Answer: "No. Start with the best information you have. Clarification questions help refine the scope before contractors submit full proposals.",
        item2Question: "Can I compare more than price?",
        item2Answer: "Yes. BuilTHAI is meant to show context around proposals, including notes, scope understanding, and the contractor path to signing.",
        item3Question: "When does contract work begin?",
        item3Answer: "After you select a contractor and the signing flow is complete, the project can move into the agreed contract terms and follow-up project workflow.",
      },
      finalTitle: "Ready to publish your first project?",
      finalBody: "Start with a simple project brief, then refine it as contractors ask better questions.",
      finalPrimaryCta: "Post a project",
      finalSecondaryCta: "Read help",
    },
    contractors: {
      navLabel: "For contractors",
      quickLead: "See how to set up your profile, find matching jobs, and submit proposals without guessing the process.",
      heroKicker: "For contractors",
      heroTitle: "See how BuilTHAI helps you win better-fit projects",
      heroLead: "BuilTHAI helps contractors build a profile, discover matching opportunities, ask clarifications, and move from proposal to signing in one workflow.",
      heroPrimaryCta: "Open contractor portal",
      heroSecondaryCta: "Open help",
      mockupEyebrow: "Bid workflow",
      mockupHeadline: "A clearer path from match to signed contract",
      mockupDetail: "Keep your profile, project applications, clarifications, proposal status, and signing steps connected in one place.",
      mockupMetricTitle: "Faster decisions",
      mockupMetricBody: "Match, propose, sign",
      mockupPill1: "Company profile",
      mockupPill2: "Matched projects",
      mockupPill3: "Proposal status",
      mockupPill4: "Signature request",
      stepsTitle: "How it works",
      stepsLead: "A short path from profile setup to selected bid.",
      steps: {
        step1Title: "Set up your contractor profile",
        step1Body: "Add company details, work types, service areas, and contact preferences so the right projects can find you.",
        step2Title: "Review matching opportunities",
        step2Body: "Browse projects that fit your specialties and quickly decide which ones are worth your time.",
        step3Title: "Ask clarifications and submit a proposal",
        step3Body: "Get scope answers before pricing, then send a more confident proposal with fewer assumptions.",
        step4Title: "Handle signing in the same flow",
        step4Body: "When selected, continue through fee disclosure, authorization, and contract signing without jumping across tools.",
      },
      benefitsTitle: "What you get",
      benefitsLead: "Built to reduce wasted effort and improve fit.",
      benefits: {
        item1Title: "Better project matching",
        item1Body: "Your profile, locations, and specialties help surface more relevant opportunities first.",
        item2Title: "Fewer blind bids",
        item2Body: "Clarifications make it easier to understand the job before you commit time to pricing.",
        item3Title: "A visible proposal pipeline",
        item3Body: "Track where each project sits: applying, proposing, selected, or moving into signing.",
        item4Title: "Less admin friction",
        item4Body: "Bank details, authorization, and contract steps are tied to the same project flow.",
      },
      faqTitle: "Common questions",
      faqLead: "The most likely questions from a new contractor.",
      faq: {
        item1Question: "Do I need to complete everything before browsing projects?",
        item1Answer: "No. You can explore first, but a stronger profile helps the platform match you more accurately and helps clients trust your proposal.",
        item2Question: "How do I avoid pricing the wrong scope?",
        item2Answer: "Use the clarification step early. It is the fastest way to remove hidden assumptions before you prepare a commercial proposal.",
        item3Question: "What happens after I am selected?",
        item3Answer: "You continue into the signing flow on the same project, including fee disclosure, authorization, and contract execution steps.",
      },
      finalTitle: "Ready to start bidding with less guesswork?",
      finalBody: "Create your profile, pick the right projects, and submit proposals with a clearer scope.",
      finalPrimaryCta: "Open contractor portal",
      finalSecondaryCta: "Read help",
    },
  },
  materials: {
