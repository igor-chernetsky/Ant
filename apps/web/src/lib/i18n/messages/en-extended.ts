export const enExtended = {
  ...
  help: {
    ...
    contractorSectionLead: "Get verified, find matching work, and submit commercial proposals.",
    ...
    contractorScenario2Step3: "Submit a commercial proposal (KP) before the deadline.",
