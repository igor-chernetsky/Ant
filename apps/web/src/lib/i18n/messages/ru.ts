...
export const ru: Messages = {
  ...
  header: {
    ...
    contactFormHint: 'Укажите email или телефон, чтобы мы могли ответить.',
  ...
  emailUnsubscribe: {
    brand: 'BuilTHAI',
    titleLoading: 'Отписка',
    titleOk: 'Вы отписаны',
    titleError: 'Не удалось отписаться',
    loading: 'Отписываем…',
    missingToken: 'Ссылка для отписки отсутствует или недействительна.',
    success:
      'Вы больше не будете получать письма о подходящих проектах. Включить их снова можно в Аккаунт → Уведомления.',
    genericError:
      'Сейчас не удалось отписаться. Попробуйте позже.',
    expiredError:
      'Не удалось отписаться. Возможно, срок действия ссылки истёк.',
    openAccount: 'Открыть настройки аккаунта',
    home: 'На главную',
  },
  ...extendedNamespaces,
};
