...
export const th: Messages = {
  ...
  auth: {
    ...
    roleHint: 'เลือกได้หนึ่งบทบาทขึ้นไป คุณสามารถเปลี่ยนได้ภายหลัง',
    ...
    roleClientDesc: 'ต้องการเผยแพร่โปรเจกต์และจ้างมืออาชีพ',
    roleContractorDesc: 'ต้องการค้นหาโปรเจกต์และยื่นข้อเสนอ',
    roleDesignerDesc: 'ต้องการให้บริการออกแบบและขอใบอนุญาต',
  ...
  emailUnsubscribe: {
    brand: 'BuilTHAI',
    titleLoading: 'ยกเลิกการสมัคร',
    titleOk: 'ยกเลิกการสมัครแล้ว',
    titleError: 'ยกเลิกการสมัครไม่สำเร็จ',
    loading: 'กำลังยกเลิกการสมัคร…',
    missingToken: 'ลิงก์ยกเลิกการสมัครหายไปหรือไม่ถูกต้อง',
    success:
      'คุณจะไม่ได้รับอีเมลแจ้งโครงการที่ตรงกันอีก คุณสามารถเปิดใหม่ได้ที่ บัญชี → การแจ้งเตือน',
    genericError:
      'ยกเลิกการสมัครไม่ได้ในขณะนี้ กรุณาลองใหม่ภายหลัง',
    expiredError:
      'ยกเลิกการสมัครไม่ได้ ลิงก์อาจหมดอายุแล้ว',
    openAccount: 'เปิดการตั้งค่าบัญชี',
    home: 'หน้าแรก',
  },
  ...extendedNamespaces,
};
