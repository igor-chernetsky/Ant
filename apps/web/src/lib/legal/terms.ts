  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Модель сборов: (a) сбор за подписание — 20 USD (или 2% от суммы выбранного договора, если меньше), раскрывается при запросе авторизации подписи и засчитывается в success fee; (b) success fee — 2% от суммы выбранного договора за вычетом сбора за подписание. Остаток success fee подлежит оплате в течение двух недель после подписания, обычно после получения аванса от заказчика.',
