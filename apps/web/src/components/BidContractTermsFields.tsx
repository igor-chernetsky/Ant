...
export function BidContractTermsFields({
  ...
  return (
    <div className="bid-contract-terms">
      <p className="tag-section-label">Contract document (КП)</p>
      <p className="muted bid-contract-terms-hint">
        These fields populate the downloadable commercial proposal for both
        parties. Based on sample construction contracts in{' '}
      ...
      <div className="bid-proposal-form-row bid-proposal-form-row--metrics">
        ...
        <label className="bid-proposal-field">
          <span className="field-label">Or fixed advance (THB)</span>
          <input
            type="number"
            min="0"
            disabled={disabled}
      ...
      <div className="bid-proposal-form-row bid-proposal-form-row--metrics">
        ...
        <label className="bid-proposal-field">
          <span className="field-label">Retention cap (% of contract)</span>
          <input
            type="number"
            min="0"
            max="100"
      ...
      <details className="bid-contract-terms-advanced">
        ...
        <div className="bid-contract-terms-advanced-body">
          <label>
            Employer legal name
            <input
              type="text"
